...
void delete_last();//Declaration of insert first node.
...
display();
printf("\n");
printf("\nPress 1 to delete last node of the list:\n");
scanf("%d",&choice);
if (choice==1)
{
  delete_last(); 
...
printf("After Deleting  the Node at  the last of Doubly link list is:\n");
...
void delete_last()
{
    ...
    temp2->next=NULL;
    free(temp);
printf("\nCONGRATS Node Deleted  Successfuly at the last of the list\n");
}
